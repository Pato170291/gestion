...
@section('content')
    ...
    <form class="formulario-proveedor" method="POST" action="/proveedores/{{ $proveedor->id }}">
        @csrf
        @method('PUT')
        ...
        <fieldset class="grupo-proveedor">
            ...
            <div class="campo-proveedor">
                ...
                <input type="text" id="empresa" name="empresa" value="{{ old('empresa', $proveedor->empresa) }}" required>
            </div>

            <div class="campo-proveedor">
                <label for="contacto">Contacto (opcional)</label>
                <input type="text" id="contacto" name="contacto" value="{{ old('contacto', $proveedor->contacto) }}">
            </div>
        ...
        <button type="submit" class="boton-proveedor">Guardar cambios</button>
